...
public class BoutonPlay extends JButton implements MouseListener{
    ...
    public BoutonPlay(String str){
        super(str);
        this.name = str;

        try {
            img = ImageIO.read(new File("../ressources/images/DevintJouerO.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void paintComponent(Graphics g){
        ...
        g2d.setFont(new Font("Georgia",1,80));
        //FontMetrics font= g2d.getFontMetrics();
        g2d.drawString(this.name, 100 , 60);
    }
    ...
    public void mouseEntered(MouseEvent event) {
        ...
        try {
            img = ImageIO.read(new File("../ressources/images/DevintJouerX.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
