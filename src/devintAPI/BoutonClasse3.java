...
public class BoutonClasse3 extends JButton implements MouseListener{
    private String name;
    private Image img;
    private Image img2;
    ...
    public BoutonClasse3(String str,File imageFile){
        super(str);
        this.name = str;

        try {
            //img2 = ImageIO.read(new File("../ressources/images/cornemuse.png"));
    ...
    public void setChange(File imageFile) {
        try {
            //img2 = ImageIO.read(new File("../ressources/images/cornemuse.png"));
            img2 = ImageIO.read(imageFile);
            img = ImageIO.read(new File("../ressources/images/noncliquer.png"));
